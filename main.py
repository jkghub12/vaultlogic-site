    ...
    <html>
        <head>
            ...
            <style>
                ...
                .account-info {{ color: #00ffcc; font-size: 12px; font-family: monospace; margin: 15px 0; }}
                w3m-button {{ margin-top: 10px; display: inline-block; }}
            </style>
        </head>
        <body>
            <div class="mission-brief">
                ...
                <div class="account-info">
                    WALLET: {display_addr} | BALANCE: {vault_cache['wallet_balance']}
                </div>
                ...
                watchAccount(config, {{
                  async onChange(account) {{
                    if (account.isConnected) {{
                      ...
                      const formattedBal = balanceData.formatted.substring(0, 6) + " " + balanceData.symbol;
