...
def save_to_db(aave_rate, uni_rate):
    ...
    conn = None
    try:
        # We use a 10s timeout to ensure we don't hang the whole engine
...
def get_all_yields():
    ...
    # Save to history AFTER fetching blockchain data
